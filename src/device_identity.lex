# device_identity.lex — device certificates + signed-reading verification.
#
# The substrate that lets a tamper-evident trail start AT the device instead of
...
#
# This is the single home for the envelope: the platform (lex-soft) issues certs,
# and any ingest service (lex-telemetry, …) verifies signed readings against them.
